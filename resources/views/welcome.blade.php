...
<head>
    ...
    {{-- Panggil asset stylesheet menggunakan Vite --}}
...
<body>
    <div class="container text-center my-5">
        ...
        <img class="img-thumbnail" src="{{ Vite::asset('resources/images/laravel.webp') }}" alt="image">
    ...
    {{-- Panggil asset script JavaScript menggunakan Vite --}}
